...
export type PostsGetAllQueryVariables = Exact<{
  limit?: InputMaybe<Scalars['IntType']['input']>;
}>;


export type PostsGetAllQuery = { __typename?: 'Query', allPosts: Array<{ __typename: 'PostRecord', id: string, title: string, slug: string, date: string, poster: { __typename: 'FileField', url: string }, content: { __typename: 'PostModelContentField', value: StructuredTextGraphQlResponse<StructuredTextGraphQlResponseRecord,StructuredTextGraphQlResponseRecord>, blocks: Array<{ __typename: 'GalleryRecord', id: string, images: Array<{ __typename: 'FileField', id: string, url: string, alt?: string | null, width?: number | null, height?: number | null, blurhash?: string | null }> } | { __typename: 'VideoRecord', id: string, video: { __typename?: 'VideoField', title: string, provider: string, providerUid: string, thumbnailUrl: string } }> } }> };
