  ...
  return (
    <div className="leading-relaxed">
      ...
      <p className="mb-4">
        ...
        Raspberry Pi. The restless mind that I am wants to learn and expand
        knowledge all the time. Besides that, I really love traveling, trying
        new things and pushing my own limits. Also kind of a data geek, charts &
        stats are real motivators for me.
      </p>
      <p className="mb-4">
        Since 2017 involved in the crypto space and really started to appreciate
